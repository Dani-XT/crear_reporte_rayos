...
APP_NAME = os.getenv("APP_NAME", "CrearReporteRayos")
APP_DEBUG = _to_bool(os.getenv("APP_DEBUG"), default=(APP_ENV == "dev"))

APP_SQL_SERVER = os.getenv("SQL_SERVER", "")
APP_SQL_DATABASE = os.getenv("SQL_DATABASE", "")
APP_SQL_USERNAME = os.getenv("SQL_USERNAME", "")
APP_SQL_PASSWORD = os.getenv("SQL_PASSWORD", "")
